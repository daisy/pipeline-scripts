...
<p:declare-step type="pxi:translate-files" name="main"
    ...
    <p:declare-step type="pxi:update-liblouis-results" name="update-liblouis-results">
        ...
        <p:wrap-sequence wrapper="louis:_" name="wrap-update">
            <p:input port="source">
                <p:pipe step="update-liblouis-results" port="update"/>
            </p:input>
        </p:wrap-sequence>
    ...
    <p:wrap-sequence wrapper="louis:_" name="source.all">
        <p:input port="source">
    ...
    <p:wrap-sequence wrapper="louis:_" name="temp-result.all">
        <p:input port="source">
            <p:pipe step="main" port="temp-result.valid"/>
            <p:pipe step="main" port="temp-result.invalid"/>
            <p:inline><louis:_/></p:inline>
        </p:input>
    </p:wrap-sequence>
    <p:sink/>
    
    <p:wrap-sequence wrapper="louis:_" name="temp-result.valid.all">
        <p:input port="source">
            <p:pipe step="main" port="temp-result.valid"/>
            <p:inline><louis:_/></p:inline>
        </p:input>
