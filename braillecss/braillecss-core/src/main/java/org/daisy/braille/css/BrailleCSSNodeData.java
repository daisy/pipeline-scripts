...
/**
 * Copied from {@link SingleMapNodeData}
 * Adapted to use custom {@link BrailleCSSDeclarationTransformer}
 * @author bert
 * 
 ...
 * @author kapy
 */
public class BrailleCSSNodeData implements NodeData {

	private static final int COMMON_DECLARATION_SIZE = 7;
	
	protected static BrailleCSSDeclarationTransformer transformer = BrailleCSSDeclarationTransformer.getInstance();
	protected static SupportedCSS css = CSSFactory.getSupportedCSS();
	
	private Map<String, Quadruple> map;
	
	public BrailleCSSNodeData() {
