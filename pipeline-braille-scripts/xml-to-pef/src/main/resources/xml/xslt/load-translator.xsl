...
<xsl:stylesheet version="2.0"
	...
	<xsl:variable name="registered-translators">
		<resource-paths>
			<resource-path id="http://www.daisy.org/pipeline/modules/braille/xml-to-pef/xslt/">
			...
			<resource-path id="http://www.daisy.org/pipeline/modules/braille/xml-to-pef/xproc/">
