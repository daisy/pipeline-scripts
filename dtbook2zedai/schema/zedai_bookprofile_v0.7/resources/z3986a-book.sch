...
<schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
        ...
        queryBinding="xslt2"><!--generated: 2010-12-02T11:27:15.391-08:00--><!--input file: file:/Users/marisa/Devel/zed/trunk/temp/all-src-rng-preprocessed/z3986a-book.rng--><title>ISO Schematron tests for Book Profile version 0.7</title>
   ...
   <pattern>
      ...
      <sch:rule context="*[@continuation and @xml:id]">
         <sch:assert test=" every $id in distinct-values(tokenize(string-join(//@continuation,' '),'\s+')) satisfies $id ne current()/@xml:id">Elements referenced by a continuation attribute must not carry a continuation attribute</sch:assert>
      </sch:rule>
      <sch:rule context="*[@continuation]">
         <sch:assert test=" every $id in tokenize(normalize-space(@continuation),'\s') satisfies name(//*[@xml:id eq $id]) eq name(current())">Elements referenced by a continuation attribute must have the same QName as the referencing element.</sch:assert>
         <sch:assert test=" every $id in tokenize(normalize-space(@continuation),'\s') satisfies current() &lt;&lt; //*[@xml:id eq $id]">Elements referenced by a continuation attribute must be located after (in document order) the referencing element.</sch:assert>
         <sch:assert test=" every $id in tokenize(normalize-space(@continuation),'\s') satisfies not(current() is //*[@xml:id eq $id])">Elements carrying a continuation attribute must not reference themselves.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="default:abbr">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The abbr element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="default:annotation[not(@role='temporary')]">
         ...
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The annotation element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:aside">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The aside element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:bibliography//default:entry">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The entry element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:block">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The block element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:caption">
         ...
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The caption element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:citation">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The citation element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="default:code">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The code element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="default:d">
         ...
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The d element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:definition">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The definition element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:description">
         <sch:assert test="(count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0) or @xlink:href">The description element must either contain text data or point to an external resource using the xlink:href attribute.</sch:assert>
         <sch:report test="(count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0) and @xlink:href">The description element must not contain text data and also point to an external resource using the xlink:href attribute.</sch:report>
      ...
      <sch:rule context="default:emph">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The emph element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:expansion">
         ...
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The expansion element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="default:h">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The h element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:hd">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The hd element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="default:hpart">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The hpart element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="default:ln">
         ...
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The ln element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:lnum">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The lnum element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="default:name">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The name element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:note">
         ...
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The note element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="default:num">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The num element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="default:p">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The p element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:quote">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The quote element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:ref">
         ...
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The ref element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:s">
         ...
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The s element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:span">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The span element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:sub">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The sub element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:sup">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The sup element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:term">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The term element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="default:time">
         ...
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The time element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:w">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The word element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="default:wpart">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The wpart element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="m:annotation-xml">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The annotation-xml element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="ssml:phoneme">
         ...
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The ssml:phoneme element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="ssml:prosody">
         ...
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The ssml:prosody element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="ssml:say-as">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The ssml:say-as element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="ssml:sub">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The ssml:sub element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
      <sch:rule context="ssml:token">
         <sch:assert test="count(*) &gt; 0 or string-length(normalize-space(.)) &gt; 0">The ssml:token element must neither be empty nor contain only whitespace.</sch:assert>
      </sch:rule>
   </pattern>
</schema>